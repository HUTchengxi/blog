...
<link rel="stylesheet" href="css/keysearch/home.css" />
</head>
<body>
	...
	<header>
		...
		<nav>
			<ul class="clearfix">
				...
				<li><a href="allblog" title="个人博客大杂烩">博客汇总</a>
				</li>
		...
		<div class="left-content">
			<div class="search-box">
				<input type="text" name="keyword" class="keyword"
					placeholder="输入关键字查找指定博客" />
				<span class="glyphicon glyphicon-remove"></span>
				<button type="button" class="search">点击查找</button>
			</div>
			<div class="search-result">
				<h5>
					关于"<span class="key"></span>"的结果:
				</h5>
				<div class="result-pager">
					<ul class="pager clearfix">
						<li><a href="javascript:void(0);" title="点击查看上一页"
							class="disabled" z-limit="0"> <span
								class="glyphicon glyphicon-chevron-left"></span> </a>
						</li>
						<li><a href="javascript:void(0);" title="点击查看下一页" z-limit="0">
								<span class="glyphicon glyphicon-chevron-right"></span> </a>
						</li>
					</ul>
				</div>
				<div class="result-content articletj">
					<ul>
					</ul>
				</div>
			</div>
			<h4>
				猜你喜欢<a href="javascript:void(0);" class="change"><span>换一换</span>
				</a>
			</h4>
			<div class="articletj rlike">
				<ul>
				</ul>
			</div>
		</div>
	...
	<script src="js/keysearch/load.js"></script>
