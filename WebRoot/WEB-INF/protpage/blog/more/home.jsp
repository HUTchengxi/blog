...
<link rel="stylesheet" href="css/blog/more/home.css" />
</head>
<body>
	...
	<header>
		...
		<div class="pageshow clearfix">
			<span class="glyphicon glyphicon-search flo"></span> <a
				href="allblog" class="flo">博客汇总</a> <span
	...
	<div class="main-content clearfix">
		<div class="left-content">
			...
			<ul class="pager clearfix">
				<li><a href="javascript:void(0);" title="点击查看上一页"
					class="prevp"> <span
						class="glyphicon glyphicon-chevron-left"></span> </a></li>
				<li><a href="javascript:void(0);" title="点击查看下一页" class="nextp">
						<span class="glyphicon glyphicon-chevron-right"></span> </a></li>
			</ul>
			<div class="articletj main">
				<ul>
					<!-- 
					<li class="clearfix">
						<div class="article-img">
							<a href="" target="_blank"> <img
								src="images/test/bannerL1.jpg" title="人与人之间的信任" /> </a>
						</div>
						<div class="article-content">
							<h3 class="title">如何建立自己的个人博客</h3>
							<div class="author-info">
								<p class="author">
									<a href=""> <img src="images/test/bannerL2.jpg" /> </a> 成兮
								</p>
								<span class="pubtime">发布时间：2017-07-30 10:00:00</span> <span
									class="classifier">分类：<a href="">前端开发</a> </span>
							</div>
			...
			<!-- 
			<div class="articletj xq">
				<h4>
					感兴趣<a href="javascript:void(0);" class="change" data-type="front"><span>换一换</span>
					</a>
				</h4>
				<ul>
					<li class="clearfix">
					...
					<li class="clearfix">
						...
						<div class="article-content">
							...
							<div class="author-info">
								<p class="author">
									<a href=""> <img src="images/test/bannerS2.jpg" /> </a> 成兮
								</p>
								<span class="pubtime">发布时间：2017-07-30 10:00:00</span> <span
									class="classifier">分类：<a href="">前端开发</a> </span>
							</div>
		...
		<div class="right-content">
					...
					<form action="keysearch">
						<div class="input-group">
							<input type="text" class="form-control" name="keyword"
								placeholder="输入关键字查找" /> 
							<input type="number" name="pagetype"
								value="2" style="position: absolute;visibility: hidden" readOnly />
			...
			<div class="news-guest">
				<h4 class="divh">
					最新留言 <a href="goguest"> <span class="morelink">更多 <span
			...
			<div class="longwaybox">
				<h4 class="divh">
					一路走来 <a href="longwaymore"> <span class="morelink">更多 <span
							class="glyphicon glyphicon-chevron-right"></span> <span
	...
	<script src="js/blog/more/load.js"></script>
