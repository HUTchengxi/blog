...
<body>
	...
	<header>
		...
		<nav>
			<ul class="clearfix">
				...
				<li><a href="goguest" title="成兮个人博客首页">留言板</a>
				</li>
	...
	<div class="main-content clearfix">
		<div class="left-content">
			...
			<div class="articletj program">
				<ul>
					<!-- 
					<li class="clearfix">
						<div class="article-img">
							<a href="" target="_blank"> <img
								src="images/test/bannerS1.jpg" title="人与人之间的信任" /> </a>
						</div>
			...
			<div class="articletj sql">
				<ul>
					<!-- 
					<li class="article-none">
						<div class="article-none">
							<h4>
								<span class="glyphicon glyphicon-exclamation-sign"></span>该年份无记录
							</h4>
						</div>
					</li>
					 -->
	...
	<script src="js/blog/load.js"></script>
