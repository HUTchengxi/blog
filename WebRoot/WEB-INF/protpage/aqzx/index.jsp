...
<head>
	...
	<link rel="stylesheet" href="css/aqzx/info_content.css" />
	<link rel="stylesheet" href="css/login/loading.css" />
	<link rel="stylesheet" href="css/aqzx/lock.css" />
	
	<!-- js link -->
	<script src="js/aqzx/info_mod.js"></script>
	<script src="js/aqzx/info_load.js"></script>
