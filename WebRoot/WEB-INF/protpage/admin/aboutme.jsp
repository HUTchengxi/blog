...
<body>
	...
	<header>
		...
		<nav>
			<ul class="clearfix">
				...
				<li><a href="allblog" title="个人博客大杂烩">博客汇总</a></li>
				...
				<li><a href="welcome" title="成兮个人博客首页">留言板</a></li>
				<li class="licli"><a href="aboutme" title="成兮个人博客首页">相关介绍</a></li>
			</ul>
		</nav>
	</header>
	...
	<script src="js/admin/aboutme_gobtn.js"></script>
	<script src="js/all_isnull.js"></script>
	<script src="js/admin/aboutme.js"></script>
